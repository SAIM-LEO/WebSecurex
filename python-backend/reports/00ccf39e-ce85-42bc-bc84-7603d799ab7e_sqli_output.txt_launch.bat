...
echo ============================================================
echo.
E:\WebSecureX.(2)\venv\Scripts\python.exe ..\engines\sqli_engine\sqlmap\sqlmap.py -u https://pu.edu.pk/home/bs4yearsdegree/BS-4Years-Information-Technology-NC.html --batch --level=2 --risk=1 --forms --random-agent --output-dir=E:\WebSecureX.(2)\python-backend\reports\00ccf39e-ce85-42bc-bc84-7603d799ab7e\sqlmap
echo.
echo ============================================================
